...
* Matching `print()` statements echo the key events so runtimes that only
  capture raw stdout (e.g. Docker logs) still show:
...
def classify(article: Article) -> tuple[bool, int]:
    ...
    system = (
        ...
        "Sentiment scale: -5 very negative, 0 neutral, 5 very positive."
    )
